...
const faciles = {
  'centigradosFahrenheit': " Dado un número en centígrados debes devolver su mismo valor en Fahrenheit\n"+
                            ...
                            " Cuando hayas terminado teclea probarProblemaFacil('centigradosFahrenheit');",
  ...
  'coinMachine': " Una máquina que proporciona cambio.\n"+
                  ...
                  " Cuando hayas terminado teclea probarProblemaFacil('coinMachine')",
  'valorMaxArray': " Dado un arreglo de números, recorrer el mismo para poder dar un\n"+
